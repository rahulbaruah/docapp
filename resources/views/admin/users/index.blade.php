...
@foreach ($users as $key=>$user)
		<tr>
			...
			<td>{{ $user->role }}</td>
			<td>
				<a class="btn btn-default" href="{{ route('users.edit', ['id' => $user->id]) }}" role="button" title="Edit">
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
				</a>
				@if ($user->id > 1)
				<a class="delBtn btn btn-danger" href="#" data-href="{{ route('users.destroy', ['id' => $user->id]) }}" role="button" title="Delete">
